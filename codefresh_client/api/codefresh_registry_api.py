...
class CodefreshRegistryApi(object):
    ...
    def registries_delete(self, id, **kwargs):  # noqa: E501
        """Delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.registries_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.registries_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.registries_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def registries_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.registries_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `registries_delete`")  # noqa: E501
