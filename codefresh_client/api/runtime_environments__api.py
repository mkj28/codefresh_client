...
class RuntimeEnvironmentsApi(object):
    ...
    def on_prem_runtime_envs_plan_get(self, plan, runtime_environment_name, **kwargs):  # noqa: E501
        """Get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.on_prem_runtime_envs_plan_get(plan, runtime_environment_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.on_prem_runtime_envs_plan_get_with_http_info(plan, runtime_environment_name, **kwargs)  # noqa: E501
        else:
            (data) = self.on_prem_runtime_envs_plan_get_with_http_info(plan, runtime_environment_name, **kwargs)  # noqa: E501
            return data

    def on_prem_runtime_envs_plan_get_with_http_info(self, plan, runtime_environment_name, **kwargs):  # noqa: E501
        """Get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.on_prem_runtime_envs_plan_get_with_http_info(plan, runtime_environment_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['plan', 'runtime_environment_name', 'version', 'extend', 'history', 'successors']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('runtime_environment_name' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `runtime_environment_name` when calling `on_prem_runtime_envs_plan_get`")  # noqa: E501
